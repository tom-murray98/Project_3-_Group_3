...
gatk SelectVariants -V LAB_NEN_ODN.clean_BI.ann.vcf.gz --select "AF > 0.00"  -sn LAB_1 -sn LAB_2 -sn LAB_300 -sn LAB_4 -sn LAB_004 -sn LAB_400 -sn LAB_5 -sn LAB_500 -O LAB_AF_filt.vcf
